...
Добавить в 2 конструктора в основной класс (по умолчанию - без параметров, с классом конвертером в параметре) - можно использовать генерацию из идеи: right-click -> Generate.. -> Constructor
